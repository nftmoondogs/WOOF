...
<div class=" w-full max-w-sm bg-ddd rounded-lg  shadow-md dark:bg-ddd dark:border-ddd">
    ...
    <div class="flex flex-col items-center pb-10">
        ...
        <a href="https://twitter.com/woofcoin" target="_blank" rel="noreferrer" class=" w-[240px] items-center py-2 px-4 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Twitter</a>
        </div>

        <div class="flex mt-4 space-x-3 md:mt-6">
        <a href="https://explorer.solana.com/address/3DZE5m1siuULWiwNF4gUDu5noYBvdWS8dZ4GERYx6nhg" target="_blank" rel="noreferrer" class=" w-[240px] items-center py-2 px-4 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Official Contract</a>
        </div>
